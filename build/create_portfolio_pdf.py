...
def bg(canvas,doc):
    ...
    canvas.setFont("Inter",6.5); canvas.setFillColor(MUTED); canvas.drawString(18*mm,9*mm,"ANDRÉS FELIPE MARTÍNEZ · REMOTE / UTC-5")
